...
var CheckoutUtils = function() {
    ...
    return console.log(dia + "/" + mes + "/" + ano),
        ...
        CheckoutUtils.prototype.mensagemBrindes = function() {
            ...
            if (msgEl.length > 0 && msgEl.remove(), (total > 0 && total <= 900 ? total > 599 ? (txToAppendCnt = 'Parabéns! Você ganhou <span style="color: #c50e1f;">frete grátis</span>.', (txToAppendCnt += " Compre mais R$ " + rest2 + ' e ganhe uma <span style="color: #bdcbff;"> ' + brinde + "</span> do dia dos namorados")) : (txToAppendCnt += " ou mais R$ " + rest2 + ' e ganhe uma<span style="color: #84897a;"> ' + brinde + "</span> do dia dos namorados") : (txToAppendCnt = 'Parabéns! Você ganhou <span style="color: #c50e1f;">frete grátis</span>.', (txToAppendCnt += ' e uma<span style="color: #84897a;"> ' + brinde + "</span> do dia dos namorados"))), total && total > 0) {
                var newEl = $("<div/>", {
